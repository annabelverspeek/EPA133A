...
# only the columns in the bridge dataset are imported that align with the demofile. As extra, the condition of the bridges is added. The column condition is also added in the run methods to make sure this column is taken along.
