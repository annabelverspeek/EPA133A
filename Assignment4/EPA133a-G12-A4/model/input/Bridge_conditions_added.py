...
path_bmms = '../output/BMMS_overview.xlsx'
bmms_df = pd.read_excel(path_bmms)

traffic_df = pd.read_csv('../output//latlonloads.csv')
...
final_df.to_csv('../output/bridge_condition_counts.csv', index=False)
...
sorted_final_df['name'].to_csv('../output/Vulnerability.csv', index=False)
