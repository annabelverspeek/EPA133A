...
combined_df.to_csv('../output/combined_lrps.csv', index=False)

#Check the traffic dataframe
traffic_df = pd.read_csv('../output/traffic.csv')
...
latlonload.to_csv('../output/latlonloads.csv')
...
sorted_latlonload['name'].to_csv('../output/Criticality.csv', index=False)
